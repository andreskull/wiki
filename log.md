...
## [2026-08-22] wrapup | gor_dagster | The Intrinsic Value Podcast ingestion
## [2026-08-22] sync | gor_dagster — Intrinsic Value wrapup: Pattern 7 PPLLC, 12th podcast_rss source, 784/784 downloaded; updated [[projects/gor_dagster]], [[concepts/onboarding-new-podcast-source]], [[products/finfluencer-trade]], [[overview]], [[index]]. Permanent doc `docs/architecture/features/intrinsic-value-podcast-ingestion.md`; `docs/features/intrinsic-value-podcast-ingestion/` removed.

## [2026-08-31] decision-filed | Exclude employees of registered financial entities from finfluencers.trade outreach — MoneyShow SF follow-up: a Nasdaq speaker declined on compliance grounds; finding generalises (6 of 12 personalised-sheet speakers sat in registered firms; live LinkedIn cohort included Kevin Davitt of Nasdaq). New [[decisions/exclude-regulated-finance-employees-from-outreach-2026-08]]; updated [[index]]. Enforced in `gor_dagster` via a fail-closed Notion `Affiliation` gate in the outreach scripts + runbook; new `docs/operations/conference-outreach-playbook.md`; `gor-blog/growth_plan.md` gained *Who cannot be an early design partner*.

## [2026-09-02] sync | finfluencer-tracker — GA4 read-only health check found the Web Vitals instrumentation pipe healthy but zero custom dimensions/metrics registered (T0.3/T0.5 gap); event parameters arrived and were populated but unqueryable in Explore/Reports since Aug 31. Registered 10 event-scoped custom dimensions + the `metric_value` custom metric; linked BigQuery export to GCP `gurus-on-record` (Daily, US multi-region — kept, closed same day). `T1.0b` measurement window restarted; `T1.1a` earliest ~2026-09-05/06. Updated [[projects/finfluencer-tracker]], [[concepts/core-web-vitals-mobile]], [[entities/bigquery]], [[overview]], [[index]]; added [[decisions/ga4-instrumentation-registration-2026-09]]. Project-side docs (`docs/ops/core-web-vitals.md`, `docs/features/core-web-vitals/tasks.md`) were already written and committed separately (`5c9666f`, `4815013`, `8cd603d`).

## [2026-09-04] wrapup | gor_dagster | Google Ads creative assets
## [2026-09-04] sync | gor_dagster — Google Ads PMax creatives wrapup: resolve + write-once GCS archive; featured subject ranked on scored picks at `1y` (not alpha); live run `2026-09-04T0804Z` (V1 + V4). New [[concepts/google-ads-creative-assets]]; updated [[projects/gor_dagster]] (decisions, completed features, ops, GCS `marketing/google-ads/`), [[entities/gcs]], [[products/finfluencer-trade]], [[overview]], [[index]]. Permanent doc `docs/architecture/features/google-ads-creative-assets.md`; `docs/features/google-ads-creative-assets/` removed. Open: Google policy review + ad-strength check ~2–3 weeks.

## [2026-09-04] sync | finfluencer-tracker — Google Ads PMax harness wrapup: Playwright over shipped encoder; ads-only layout; additive banner/outro (invariance-guarded). Updated [[projects/finfluencer-tracker]] (status, completed features, decisions), [[concepts/cumulative-performance-charts]], [[concepts/linkedin-outreach]], [[concepts/google-ads-conversion-tracking]], [[index]]. Permanent doc `docs/architecture/features/google-ads-creative-assets.md`.

## [2026-09-06] wrapup | finfluencer-tracker | Finfluencer × ticker pick lookup
## [2026-09-06] sync | finfluencer-tracker — Ticker lookup wrapup: server-side `finfluencer_ticker_list` (ranked lists + any-ticker lookup); PostgREST 1000-row cap fixed; two box-plot charts retired; `mainstream_tickers_snapshot` pipeline dropped. New [[concepts/finfluencer-ticker-pick-lookup]]; updated [[projects/finfluencer-tracker]], [[projects/gor_dagster]] (supabase sync note), [[products/finfluencer-trade]], [[concepts/subscription-entitlement-ssot]], [[concepts/signal-performance]], [[overview]], [[index]]. Permanent doc `docs/architecture/features/finfluencer-ticker-pick-lookup.md`; `docs/features/finfluencer-ticker-pick-lookup/` removed.

## [2026-09-08] wrapup | finfluencer-tracker | Field Core Web Vitals and data-ready
## [2026-09-08] sync | finfluencer-tracker — Field CWV wrapup: first-party `web_vitals` + `DATA_READY`; field decides done / lab decides whether a change helped; `/` teaser DATA_READY still ~4 s; freeze lifted. New [[concepts/core-web-vitals-field]], [[decisions/field-authoritative-cwv-2026-09]]; amended [[concepts/core-web-vitals-mobile]]; updated [[projects/finfluencer-tracker]], [[products/finfluencer-trade]], [[overview]], [[index]]. Permanent doc `docs/architecture/features/core-web-vitals-field.md`; August mobile doc amended; `docs/features/core-web-vitals/` removed.
