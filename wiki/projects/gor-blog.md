...
**Cramer / *Mad Money* v1 (2018–2024) is closed** (2026-09-24). Catalog: [`research/cramer/CONSERVATION.md`](file:///Users/andreskull/gor-blog/research/cramer/CONSERVATION.md). A data-quality re-run is not started. Do not overwrite the public kit or the live blog post with new numbers.

- **Public** — [[projects/cramer-mad-money-research]]: frozen CSV/Parquet, analysis-only scripts, figures, working paper (Markdown + PDF). **SSRN** [6643379](https://ssrn.com/abstract=6643379). [GitHub](https://github.com/andreskull/cramer-mad-money-research). Tag the repo (for example `v1-2018-2024`) before any later export replaces `data/`.
- **Private** — **`gor-blog/research/cramer/`**: export **`scripts/`**, `SSRN_submission.md`, `SPEC_*.md`, superseded `research_plan.md`. **`promotion/`** (campaign log, findings inventory, owned-assets checklist) is a frozen May 2026 record, not a posting queue. `features/cramer-linkedin-promotion/` was deleted 2026-09-24. The next analysis, when it starts, belongs in `research/cramer/v2/`.
