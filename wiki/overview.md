...
`gor_dagster` has **four** in-progress feature folders under `docs/features/` (batch integration, social share previews, finfluencer-and-show-profiles, proof-segment-speaker-resolution follow-ons, etc.). **Dagster Cloud credit optimization** completed 2026-04-25 — see [[projects/gor_dagster]]. Temporary feature docs are not indexed here until `/wrapup`.
