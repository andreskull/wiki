...
`gor_dagster` has in-progress feature folders under `docs/features/` (recursive LLM extraction, show-profile access, batch integration, etc.). **Transcript hydration performance optimization** completed **2026-06-15** — see [[projects/gor_dagster]] and [[concepts/speaker-attribution]] Stage 2. **Resolution pipeline efficiency** completed **2026-06-10** — see [[concepts/resolution-pipeline-efficiency]]. Temporary feature docs are not indexed here until `/wrapup`.

## Key concepts to know

- [[concepts/speaker-attribution]] — two-stage LLM pipeline for naming podcast speakers; Stage 2 hydration is O(U log W + W) with FR-6 membership (2026-06-15)
