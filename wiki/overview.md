...
- [[concepts/finfluencer-ticker-pick-lookup]] — profile ticker lookup + ranked lists share `finfluencer_ticker_list`; PostgREST 1000-row cap is a silent lie; two box-plot charts retired (2026-09-05)
...
- **finfluencer-tracker:** field CWV wrapped **2026-09-08** — `/` teaser DATA_READY still ~4 s if cheaper `landing_stats` is wanted later; post-signup onboarding skip rate is a product call (17 skip / 6 complete / 29 `sign_up` in 1–8 Sep); Clarity weekly review until **2026-09-17**; official Clarity↔GA4 OAuth link deferred; Reddit CAPI / Advanced Matching deferred; Terminal SKU / product map deferred; magic-link deliverability deferred; true daily portfolio marks parked ([[concepts/core-web-vitals-field]], [[concepts/post-signup-onboarding]], [[concepts/session-replay-analytics]], [[concepts/cumulative-performance-charts]], [[concepts/reddit-ads-conversion-tracking]])
