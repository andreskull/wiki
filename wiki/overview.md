...
`gor_dagster` has in-progress feature folders under `docs/features/` (batch-integration Phase 5 recursive SI wave batch, post-cutoff IPO resolution, social share previews, etc.). **Recursive LLM extraction** (interactive path) completed **2026-07-01** — see [[projects/gor_dagster]] and [[concepts/speaker-attribution]]. **Transcript hydration performance optimization** completed **2026-06-15**. **Resolution pipeline efficiency** completed **2026-06-10** — see [[concepts/resolution-pipeline-efficiency]]. **Curation learning** (instrument resolver) completed **2026-07-07** — see [[concepts/curation-learning]]. **finfluencer-tracker landing conversion funnel** wrapped **2026-07-10** — see [[projects/finfluencer-tracker]]. Temporary feature docs are not indexed here until `/wrapup`.
