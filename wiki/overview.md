...
`gor_dagster` has in-progress feature folders under `docs/features/` (batch-integration, post-cutoff IPO resolution, etc.). **finfluencer-tracker cumulative performance charts** wrapped **2026-08-04** — profile vs S&P, `/compare`, Play, watermarked export ([[concepts/cumulative-performance-charts]]). **Chit Chat Stocks** RSS onboarding wrapped **2026-08-02**. **Investing Unscripted** wrapped **2026-07-27**. **Gemini 3.5 Flash-Lite migration** wrapped **2026-07-27**. **finfluencer-tracker subscription entitlement SSOT** wrapped **2026-07-27**. **LinkedIn enrichment** **2026-07-23**. Temporary feature docs are not indexed until `/wrapup`.
...
- **finfluencer-tracker:** Terminal SKU / product map deferred; magic-link deliverability deferred; true daily portfolio marks parked ([[concepts/cumulative-performance-charts]])
